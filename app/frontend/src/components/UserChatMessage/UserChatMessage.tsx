...
import { AirplaneTakeOffFilled,GlobeSearch20Filled, Person20Filled, Link16Filled } from "@fluentui/react-icons";
        ...
        <div className={approach == Approaches.GPTDirect ? styles.containerUngrounded : styles.container}>
            <div className={approach == Approaches.ChatWebRetrieveRead ? styles.messageweb : approach == Approaches.ReadRetrieveRead ? styles.messagework : approach == Approaches.GPTDirect ? styles.messageungrounded : styles.messagecompare}>
                {approach == Approaches.ReadRetrieveRead ? 
                    <span style={{ marginRight: '10px' }}><AirplaneTakeOffFilled primaryFill={"rgba(255, 255, 225, 1)"}/></span> : 
                ...
                approach == Approaches.CompareWebWithWork ?
                    <span style={{ marginRight: '10px' }}><GlobeSearch20Filled primaryFill={"rgba(255, 255, 225, 1)"}/><Link16Filled primaryFill={"rgba(255, 255, 225, 1)"}/><AirplaneTakeOffFilled primaryFill={"rgba(255, 255, 225, 1)"}/></span> :
                approach == Approaches.CompareWorkWithWeb ?
                    <span style={{ marginRight: '10px' }}><AirplaneTakeOffFilled primaryFill={"rgba(255, 255, 225, 1)"}/><Link16Filled primaryFill={"rgba(255, 255, 225, 1)"}/><GlobeSearch20Filled primaryFill={"rgba(255, 255, 225, 1)"}/></span> : 
                //else
